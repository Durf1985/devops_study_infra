...
packer build -var-file="$SCRIPT_PATH"/../../packer/two_vm/variables.json  "$SCRIPT_PATH"/../../packer/two_vm/app.json
packer build -var-file="$SCRIPT_PATH"/../../packer/two_vm/variables.json  "$SCRIPT_PATH"/../../packer/two_vm/db.json
